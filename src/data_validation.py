...
def data_validation(file, motorObj, propObj, batteryObj, plot_results = False):
    ...
    if plot_results:
        ...
        line2, = plt.plot(T_red, n_pred, 'r:', linewidth = 2.0, label = 'Simulation')
        ...
        plt.legend(handles = [line1, line2], loc = 2, fontsize = 8)
        ...
        line2, = plt.plot(T_red, I_pred, 'r:', linewidth = 2.0, label = 'Simulation')
        # line3, = plt.plot(delta_star, A_tube[2,:], 'g-', linewidth = 2.0, label = 'A_pod = 3.0 $m^2$')
        plt.xlabel('Thrust (gf)', fontsize = 12, fontweight = 'bold')
        ...
        line2, = plt.plot(T_red, eta_pred, 'r:', linewidth = 2.0, label = 'Simulation')
        # line3, = plt.plot(delta_star, A_tube[2,:], 'g-', linewidth = 2.0, label = 'A_pod = 3.0 $m^2$')
        plt.xlabel('Thrust (gf)', fontsize = 12, fontweight = 'bold')
